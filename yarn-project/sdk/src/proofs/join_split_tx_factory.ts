...
import { JoinSplitTx, ProofId } from '@polyaztec/barretenberg/client_proofs';
...
import { ClaimNoteTxData, deriveNoteSecret, NoteAlgorithms, TreeNote } from '@polyaztec/barretenberg/note_algorithms';
