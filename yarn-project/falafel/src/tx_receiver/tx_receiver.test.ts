...
describe('tx receiver', () => {
  ...
  beforeEach(() => {
    ...
    rollupDb = {
      nullifiersExist: jest.fn<any>().mockResolvedValue(false),
      getUnsettledDepositTxs: jest.fn<any>().mockResolvedValue([]),
      getUnsettledTxs: jest.fn<any>().mockResolvedValue([]),
      getDataRootsIndex: jest.fn<any>().mockResolvedValue(0),
      addTxs: jest.fn(),
      isAccountRegistered: jest.fn<any>().mockResolvedValue(false),
      isAliasRegistered: jest.fn<any>().mockResolvedValue(false),
    } as any;
    ...
    blockchain = {
      ...
      getUserPendingDeposit: jest.fn<any>().mockResolvedValue(10n),
      getUserProofApprovalStatus: jest.fn<any>().mockResolvedValue(false),
      validateSignature: jest.fn<any>().mockResolvedValue(true),
    } as any;
    ...
    txFeeResolver = {
      isFeePayingAsset: jest.fn<any>().mockImplementation((assetId: number) => feePayingAssets.includes(assetId)),
