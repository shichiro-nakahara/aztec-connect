...
# Runs the upgradeV5 script to perform RollupProcessor upgrade
#
...
echo -e "\n\nDeploying RollupProcessorV5...\n"

# Execute deployment solidity script
forge script UpgradeV5Prod --ffi -vvvv --private-key $PRIVATE_KEY --broadcast --rpc-url $ETHEREUM_HOST \
  --sig "deployV5(address)" \
  $PROXY
