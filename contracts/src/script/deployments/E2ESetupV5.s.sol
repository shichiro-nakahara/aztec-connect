...
contract E2ESetupV5 is Test {
    ...
    function outputAddresses(
        ...
        json.serialize("ETH_PRICE_FEED_CONTRACT_ADDRESS", _peripheryAddresses.ethPriceFeed);
        ...
        emit log_named_address("EthPriceFeed  ", _peripheryAddresses.ethPriceFeed);
